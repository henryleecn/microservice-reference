...
NOTE: This project needs to connect to a guthub location hosting the configurations
...
"https://github.com/saiyedzaidi/microservices-config":

## Pre-requisites

A github repository hosting any application configuration that we need this config server to serve.
